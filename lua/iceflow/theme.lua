...
theme.set_highlights = function()
  ...
  hl(0, "TermCursor", { fg = c.normal, bg = c.nightsky, })
  hl(0, "TermCursorNC", { fg = c.normal, bg = c.nightsky, })
  ...
  hl(0, "MatchParen", { fg = c.normal, bg = c.nightsky, })
  ...
  hl(0, "PmenuSel", { fg = c.normal, bg = c.nightsky, })
  ...
  hl(0, "Search", { fg = c.normal, bg = c.nightsky, })
  hl(0, "IncSearch", { fg = c.normal, bg = c.nightsky, })
