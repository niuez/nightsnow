local c = require('nightsnow.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "Comment", { fg = c.lightedsky, bg = 'NONE', italic=true, })
  ...
  hl(0, "NonText", { fg = c.lightedsky, bg = 'NONE' })
  ...
  hl(0, "String", { fg = c.snow2, bg = 'NONE' })
  hl(0, "Character", { fg = c.snow2, bg = 'NONE' })
  ...
  hl(0, "Delimiter", { fg = c.lightedsky, bg = 'NONE' })
  hl(0, "SpecialComment", { fg = c.lightedsky, bg = 'NONE', bold=true, })
